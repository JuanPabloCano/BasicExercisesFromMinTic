 ...
 * @author Usuario
 */
public class CreacionProductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BIENVENIDOS A ALMACEN LA MARAVILLA");
        ...
        jLabel8.setText("Cant.Min.Requerida en bodega:");

        jLabel9.setText("Cant.Máx.Inventario permitida:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreacionProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreacionProductos().setVisible(true);
            }
        });
    }
